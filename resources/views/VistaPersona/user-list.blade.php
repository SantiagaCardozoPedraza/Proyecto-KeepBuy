                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                             ...
                             <li><a title="Product List" href="{{url('VistaPersona/')}}"><span class="mini-sub-pro">Lista de usuarios</span></a></li>
                                ...
                                <li><a  href="../fruitkha-1.0.0/index.html"><span class="mini-sub-pro">Sitio web </span></a></li>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <br>
                         <a href="{{url('VistaPersona/create')}}">   <button data-toggle="tooltip" title="Crear un nuevo usuario" class="pd-setting-ed"><i  aria-hidden="true"></i>Crear un nuevo usuario</button></a>
                            <table>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
                                ...
                                <tr>
                                    @foreach($VistaPersona as $persona)
                                    <td>{{$persona->id}}</td>
                                    <td>{{$persona->NombreCliente}}</td>
                                    <td>{{$persona->ApelllidoCliente}}</td>
                                    <td>{{$persona->IdentificacionCliente}}</td>
                                    <td>{{$persona->TipoIdentificacionCliente}}</td>
                                    <td>{{$persona->FechaDeNacimientoCliente}}</td>
                                    <td>{{$persona->GeneroCliente}}</td>
                                    <td>{{$persona->DireccionCliente}}</td>
                                    <td>{{$persona->CorreoCliente}}</td>
                                    <td>{{$persona->TelefonoCliente}}</td>
                                    <td>

                                    <a href="{{url('/VistaPersona/'.$persona->id.'/edit')}}"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>

                                   
                                   
                                   
                                   
                                    <form action="{{ url('/VistaPersona/'.$persona->id) }}" method="post">
                                         @csrf
                                         {{method_field('DELETE')}}
