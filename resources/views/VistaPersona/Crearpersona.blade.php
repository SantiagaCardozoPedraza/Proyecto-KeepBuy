                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Crear Usuarios</a></li>
                                    ...
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                         ...
                                         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <form action="{{url('/VistaPersona')}}" method="post" enctype="multipart/form-data">
                                             @csrf
                                             @include('VistaPersona.Formulariopersona',['modo'=>'Crear usuarios']);
...
<!--  <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Numero de indentificacion">
                                                            </div>
                                                            <div class="input-group mg-b-pro-edt">
                                                                <span class="input-group-addon"><i class="" aria-hidden="true"></i></span>
                                                            ...
                                                            <div class="input-group mg-b-pro-edt">
                                                            <select class="form-control" placeholder="Tipo de documento" id="">
                                                            ...
                                                            <div class="input-group mg-b-pro-edt">
                                                            <select class="form-control" placeholder="Genero" id="">
