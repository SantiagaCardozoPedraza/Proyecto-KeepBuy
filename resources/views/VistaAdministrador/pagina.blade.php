                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                             ...
                             <li><a title="Product List" href="{{url('VistaPersona/')}}"><span class="mini-sub-pro">Lista de usuarios</span></a></li>
                                ...
                                <li><a  href="{{url('VistaSistema')}}"><span class="mini-sub-pro" >Sitio web </span></a></li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        @foreach($productos as $producto)
                                <tr>   
                                   ...
                                   <td>{{$producto->id }}</td>
                                   <td><img src="{{asset('storage').'/'.$producto->ImagenProducto}}" alt=""></td>
                                   <td>{{$producto->NombreProducto}}</td>
                                   
                                   <td>{{$producto->CategoriaProducto}}</td>
                                   <td>{{$producto->MarcaProducto}}</td>
                                                                  
                                   <td>{{$producto->FechaDeEntradaProducto}}</td>
                                   <td>{{$producto->FechaDeVencimientoProducto}}</td>
                                   ...
                                   <td>{{$producto->CantidadProducto}}</td>
                                    ...
                                    <td>
                                   <a href="{{url('/VistaAdministrador/'.$producto->id.'/edit')}}"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>

                                
                                    <form action="{{ url('/VistaAdministrador/'.$producto->id) }}" method="post">
