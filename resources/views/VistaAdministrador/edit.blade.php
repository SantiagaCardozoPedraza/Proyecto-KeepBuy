                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Editar producto</a></li>
                                    ...
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                         ...
                                         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <form action="{{url('/VistaAdministrador/'.$producto->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                {{method_field('PATCH')}}
                                                @include ('VistaAdministrador.form',['modo'=>'Editar Producto']);
